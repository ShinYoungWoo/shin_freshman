...
class NMT(nn.Module):
    ...
    def encode(self, source_padded: torch.Tensor, source_lengths: List[int]) -> Tuple[torch.Tensor, Tuple[torch.Tensor, torch.Tensor]]:
        ...
        dec_init_state = (self.h_projection(last_hidden.permute(1,0,2).flatten(1)),
        self.c_projection(last_cell.permute(1,0,2).flatten(1)))
    ...
    def step(self, Ybar_t: torch.Tensor,
        ...
        a_t = torch.bmm(alpha_t[:, None], enc_hiddens).squeeze(1)
        ###
